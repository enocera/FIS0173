...
if sys.platform.startswith('linux'):         
    LIBNJET = os.path.join(os.path.dirname(__file__), NJET_LIB + '/libnjet3.so')
elif sys.platform.startswith('darwin'):
    LIBNJET = os.path.join(os.path.dirname(__file__), NJET_LIB + '/libnjet3.dylib')
else:
    print ("Warning: unknown system '%s'. Library will probably fail to load." % sys.platform)
    LIBNJET = os.path.join(os.path.dirname(__file__), NJET_DIR + '/.libs/libnjet3.dll')
